...
function createEnemy() {
    ...
    for (var i = 0; i < 4; i++) {
        ...
        var enemy = {
            ...
            color: "red", speed: 2, dead: 300, img: new Image()
        };
...
function drawEnmeyList() {
    for (var i = 0; i < enemyList.length; i++) {
        ...
        ctx.drawImage(enemyList[i]["img"],
            enemyList[i]["x"] - enemyList[i]["w"] / 2,
            enemyList[i]["y"] - enemyList[i]["h"] / 2,
            enemyList[i]["imagew"],
            enemyList[i]["imageh"]);
...
function createBoss() {
    boss = {
        x: 125, y: 0, w: 700 / 5, h: 520 / 5, speed: 2, dash: 2, color: "red",
        img: new Image(), imagew: 700 / 5, imageh: 800 / 5, life: 5, state: "ready",
...
function createItem(posx, posy) {
    var item1 = {
        x: posx, y: posy, w: 50, h: 50, img: new Image(), speed: 2,
        imagew: 50, imageh: 50
    };
...
function createBolt() {
    var bolt = {
        x: player["x"] + 5, y: player["y"] - 50, w: 40, h: 40, speed: 10,
        imagew: 80, imageh: 80, img: new Image(), dead: 200, power: 10
    }
    len = boltList.length;
    boltList[len] = bolt;
    boltLevelSet();
...
var player = {
    ...
    img: new Image(), imagew: 100, imageh: 100, life: 5, lifeImg: new Image()
}
